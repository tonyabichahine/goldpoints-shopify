  ...
  return (
    <div className="min-h-screen bg-[#0f0f1a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm bg-[#16162a] border border-white/10 rounded-2xl p-8">
        ...
        <p className="text-gray-500 text-sm mb-6">Loyalty rewards</p>

        {done ? (
          <div className="text-center">
            <div className="text-4xl mb-4">✅</div>
            <p className="font-semibold text-lg mb-2">Password updated!</p>
            <p className="text-gray-400 text-sm mb-6">You can now log in with your new password in the store widget.</p>
            {shopDomain && (
              <a href={`https://${shopDomain}`} className="inline-block bg-gradient-to-r from-purple-700 to-purple-500 text-white font-bold px-6 py-3 rounded-xl text-sm">
                Return to Store →
              </a>
            )}
          </div>
