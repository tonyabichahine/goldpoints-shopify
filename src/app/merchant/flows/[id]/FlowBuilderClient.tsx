...
const PALETTE = [
  ...
  { type: 'condition', label: 'Condition',  icon: '?',  desc: 'Branch based on customer data' },
  { type: 'addPoints', label: 'Add Points', icon: '⭐', desc: 'Reward customer with points' },
  { type: 'end',       label: 'End',        icon: '🏁', desc: 'Mark flow as complete' },
]
    ...
    <div className="h-screen bg-[#0f0f1a] text-white flex flex-col overflow-hidden">
      <header className="flex items-center gap-3 px-4 py-3 bg-[#16162a] border-b border-white/10 shrink-0 z-10">
        <button onClick={() => router.push('/merchant?tab=flows')}
          className="text-gray-400 hover:text-white text-sm flex items-center gap-1 transition mr-1">← Back</button>
